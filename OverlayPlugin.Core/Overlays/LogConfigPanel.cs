...
{
    public partial class LogConfigPanel : UserControl
    {
        private LogOverlay overlay;
        private LogOverlayConfig config;

        public LogConfigPanel(LogOverlay overlay)
        {
            InitializeComponent();
        ...
        private void buttonLogReloadBrowser_Click(object sender, EventArgs e)
        {
